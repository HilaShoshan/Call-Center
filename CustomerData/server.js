...
/* doQuery("CREATE TABLE customer_data ( \
            CutomerID int PK, FirstName varchar(45), LastName varchar(45), DateOfBirth date, City varchar(45), Gender tinyint, Internet tinyint, CableTV tinyint, Cellular tinyint);" 
        ) */
